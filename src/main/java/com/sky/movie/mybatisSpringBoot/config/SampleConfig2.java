 ...
 */
package com.sky.movie.mybatisSpringBoot.config;
...
import com.sky.movie.mybatisSpring.config.DruidSourceProperties;
...
//})
@Configuration
//@ComponentScan(basePackages = "com.sky.movie")
//@MapperScan("com.sky.movie.mybatisSpringBoot.data")
@MapperScan("com.sky.movie")
...
//        properties.setProperty("offsetAsPageNum", offsetAsPageNum);
		...
		ss.setTypeAliasesPackage("com.sky.movie.mybatis.domain");
		ss.setMapperLocations(
				new Resource[] { new ClassPathResource("com/sky/movie/mybatis/data/UserMapper1.xml") });
		return ss.getObject();
	}
