...
public class MybatisAloneTest {
	...
	public void sqlSessionFactoryXML() throws IOException {
		...
		String resource = "com/sky/movie/mybatis/data/mybatis-config.xml";
		...
		try {
			User user = (User) session.selectOne("com.sky.movie.mybatisSpring.domain.User.selectUser", 1);
	...
	public void sqlSessionFactoryWithoutXML() throws IOException {
		...
		properties.setProperty("password", "cpusky");
		...
		configuration.getTypeAliasRegistry().registerAliases("com.sky.movie.mybatis"); // 全限定名缩写
